...
/**
 * Represents a Seller entity in the system.
 */
...
public class Seller implements Serializable {
  ...
  /**
   * Creates a Seller object with specified attributes.
   *
   * @param id The unique identifier for the seller.
   * @param name The name of the seller.
   * @param email The email address of the seller.
   * @param birthDate The birth date of the seller.
   * @param baseSalary The base salary of the seller.
   * @param department The department to which the seller belongs.
   */
